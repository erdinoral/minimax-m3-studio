...
mod tests {
    ...
    fn minimax_own_caption_rules_are_in_the_request_that_goes_out() {
        for target in [AssistTarget::All, AssistTarget::Prompt] {
            ...
            assert!(system.contains("280-450"), "length rule missing for {target:?}");

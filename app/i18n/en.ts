export const en = {
    ...
    stageWritingLyrics: 'Writing lyrics…',
    stageWritingCaption: 'Writing caption…',
    stageLoadingAssistant: 'Loading writing model…',
    ...
    replayAvailable: 'This track was generated from scratch and saved its audio codes — you can Re-render it later without rewriting the melody.',
    replayBadge: 'codes',
    createModeReplay: 'Replay',
    createModeSimpleHint: 'Created from the Simple tab',
    createModeAdvancedHint: 'Created from the Advanced tab',
    createModeInstrumentalHint: 'Created as an instrumental (no vocals)',
    createModeCoverHint: 'Created from the Cover tab',
    createModeReplayHint: 'Re-rendered from saved audio codes',
    workspace: 'Library',
    ...
    stylesInstrumentHint: 'Style tags like cowbell are expanded into concrete Arrangement/Sonics language so the engine can hear them. Use the wand on a section to strengthen it.',
    enhanceSection: 'Enhance this section with the writing assistant',
    producerQualityPass: 'Producer quality pass: audit and refine the complete caption',
    ...
    maxDurationAutoHint: 'Uses the engine default',
    ...
    lyricsHintAdvanced: 'Leave empty to write from Styles, or type a few keywords and tap the wand — full lyrics expand from that. Or write tagged lyrics yourself.',
    lyricsKeywordsPlaceholder: 'e.g. night drive, neon rain, lonely city…  (or leave empty → Styles theme)',
    lyricsNeedStylesOrKeywords: 'Add Styles, or type a few lyric keywords, then write lyrics.',
    instrumentalNoLyrics: 'Instrumental is on — turn it off to write lyrics.',
    captionNeedStylesOrLyrics: 'Add Styles (or lyrics) before writing the caption.',
    ...
    advancedNeedsStyles: 'Add Styles (or fill Structured caption) before generating.',
    advancedDraftingCaption: 'Writing structured caption…',
    ...
    songIdea: 'Song idea',
    songIdeaHint: 'One sentence is enough. The assistant writes lyrics and a structured description you can edit before generating.',
    songIdeaPlaceholder: 'a night drive synth-pop song about coming home, female vocal',
    writeEverything: 'Write full draft',
    ...
    coverTranscribe: 'Transcribe reference',
    coverTranscribing: 'Transcribing…',
    coverTranscriptPlaceholder: 'Reference lyrics / transcript appear here — edit before rewriting',
    coverDirectionPlaceholder: 'Optional: keep the phonk energy, male vocal, slower chorus…',
    coverRewrite: 'Rewrite as original song',
    coverNeedsReference: 'Add a transcript or a short direction first.',
    coverNeedsAsr: 'No cloud speech model is set up. An installed local Whisper or Parakeet model is used automatically; otherwise install one in Settings → Karaoke or paste lyrics manually.',
    songLanguage: 'Song language',
    songLanguageAuto: 'Auto',
    songLanguageHint: 'Locks sung lyrics language. Auto uses explicit intent or supplied lyrics — not the brief language alone.',
    stylesSection: 'Styles',
    stylesHint: 'Write freely, or tap a chip to add it.',
    stylesPlaceholder: 'e.g. dreamy phonk, warm female vocal, night drive…',
    moreOptions: 'More Options',
    excludeStyles: 'Exclude styles',
    excludeStylesPlaceholder: 'e.g. harsh metal, screaming vocals',
    ...
    aboutSectionHint: 'Version, credits, and how to help',
    aboutForkTitle: 'This build',
    aboutForkThanks: 'Special thanks to Nerual Dreming (Ilya Timonin / timoncool) for MiniMax Music3 Studio — the open-source foundation this application is built on.',
    aboutForkCredit: 'This edition was further developed and adapted on top of that project: UI, workflows, and studio behaviour for this build.',
    ...
    support: 'Support',
    supportSectionHint: 'Keep this studio maintained',
    supportTitle: 'Support this studio',
    supportBody: 'Your support means a lot to me. Building and maintaining this takes a big part of my time — every tip makes me genuinely happy, and it helps more projects like this come to life.',
    supportGithubSponsors: 'Sponsor on GitHub',
    supportKoFi: 'Tip on Ko-fi',
    supportBuyMeACoffee: 'Buy me a coffee',
    supportStarRepo: 'Star the repository',
    supportThanks: 'Thank you — even a star helps others find the project.',
